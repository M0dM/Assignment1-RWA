...
class __TwigTemplate_869f2b9773d6d28629d90f1d5ff97906 extends Twig_Template
{
    ...
    <div>
        ...
        if (array_key_exists("invalid_username", $context)) {
            // line 4
            echo "            <p>Invalid username request</p>
        ";
        }
        // line 6
        echo "        <label for=\"username\">Resetting username request</label>
        <input type=\"text\" id=\"username\" name=\"username\" required=\"required\" />
    </div>
    <div>
        <input type=\"submit\" value=\"Resetting submit request\"/>
    </div>
</form>
";
    }
